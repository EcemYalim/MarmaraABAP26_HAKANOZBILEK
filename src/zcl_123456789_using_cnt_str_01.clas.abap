CLASS zcl_123456789_using_cnt_str_01 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
    INTERFACES if_oo_adt_classrun. " Bu kısım eklendi.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS zcl_123456789_using_cnt_str_01 IMPLEMENTATION.
